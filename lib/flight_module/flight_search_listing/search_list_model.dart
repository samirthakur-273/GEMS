...
//
//     final flightSearchListModel = flightSearchListModelFromJson(jsonString);

import 'dart:convert';

FlightSearchListModel flightSearchListModelFromJson(String str) => FlightSearchListModel.fromJson(json.decode(str));

String flightSearchListModelToJson(FlightSearchListModel data) => json.encode(data.toJson());

class FlightSearchListModel {
    FlightSearchListModel({
        this.message,
        this.code,
        this.status,
        this.values,
    ...
    factory FlightSearchListModel.fromJson(Map<String, dynamic> json) => FlightSearchListModel(
...
class Values {
    ...
    factory Values.fromJson(Map<String, dynamic> json) => Values(
        flightsData: json["flightsData"] == null ? null : List<FlightsDatum>.from(json["flightsData"].map((x) => FlightsDatum.fromJson(x))),
        flightsMenu: json["flightsMenu"] == null ? null : FlightsMenu.fromJson(json["flightsMenu"]),
        type: json["type"] == null ? null : json["type"],
    );

    Map<String, dynamic> toJson() => {
        "flightsData": flightsData == null ? null : List<dynamic>.from(flightsData!.map((x) => x.toJson())),
...
class FlightsDatum {
    ...
    factory FlightsDatum.fromJson(Map<String, dynamic> json) => FlightsDatum(
        ...
        bnds: json["bnds"] == null ? null : List<String>.from(json["bnds"].map((x) => x)),
        convRate: json["convRate"] == null ? null : json["convRate"],
        bnzAccrPnts: json["bnz_accr_pnts"] == null ? null : List<int>.from(json["bnz_accr_pnts"].map((x) => x)),
        bnzReddemPnts: json["bnz_reddem_pnts"] == null ? null : List<int>.from(json["bnz_reddem_pnts"].map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "bnz_accr_pnts": bnzAccrPnts == null ? null : List<dynamic>.from(bnzAccrPnts!.map((x) => x)),
        "bnz_reddem_pnts": bnzReddemPnts == null ? null : List<dynamic>.from(bnzReddemPnts!.map((x) => x)),
...
class FlightsMenu {
    ...
    factory FlightsMenu.fromJson(Map<String, dynamic> json) => FlightsMenu(
        ...
        domReturn: json["dom_return"] == null ? null : DomReturn.fromJson(json["dom_return"]),
...
class DomReturn {
    ...
    factory DomReturn.fromJson(Map<String, dynamic> json) => DomReturn(
        pivot: json["pivot"] == null ? null : StatsClass.fromJson(json["pivot"]),
        stats: json["stats"] == null ? null : StatsClass.fromJson(json["stats"]),
    );
...
class StatsClass {
    ...
    factory StatsClass.fromJson(Map<String, dynamic> json) => StatsClass(
    );
...
class Normal {
    ...
    factory Normal.fromJson(Map<String, dynamic> json) => Normal(
        pivot: json["pivot"] == null ? null : NormalPivot.fromJson(json["pivot"]),
        stats: json["stats"] == null ? null : NormalStats.fromJson(json["stats"]),
    );
...
class NormalPivot {
    ...
    factory NormalPivot.fromJson(Map<String, dynamic> json) => NormalPivot(
        anm: json["anm"] == null ? null : List<AnmElement>.from(json["anm"].map((x) => AnmElement.fromJson(x))),
        stp: json["stp"] == null ? null : List<Btid>.from(json["stp"].map((x) => Btid.fromJson(x))),
        org: json["org"] == null ? null : List<AnmElement>.from(json["org"].map((x) => AnmElement.fromJson(x))),
        btid: json["btid"] == null ? null : List<Btid>.from(json["btid"].map((x) => Btid.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "anm": anm == null ? null : List<dynamic>.from(anm!.map((x) => x.toJson())),
        "stp": stp == null ? null : List<dynamic>.from(stp!.map((x) => x.toJson())),
        "org": org == null ? null : List<dynamic>.from(org!.map((x) => x.toJson())),
        "btid": btid == null ? null : List<dynamic>.from(btid!.map((x) => x.toJson())),
    };
}
...
class AnmElement {
    ...
    factory AnmElement.fromJson(Map<String, dynamic> json) => AnmElement(
...
class AnmStats {
    ...
    factory AnmStats.fromJson(Map<String, dynamic> json) => AnmStats(
        statsFields: json["stats_fields"] == null ? null : StatsFields.fromJson(json["stats_fields"]),
    );
...
class StatsFields {
    ...
    factory StatsFields.fromJson(Map<String, dynamic> json) => StatsFields(
        ...
        totalPrice: json["totalPrice"] == null ? null : Bfr.fromJson(json["totalPrice"]),
    );
...
class NormalStats {
    ...
    factory NormalStats.fromJson(Map<String, dynamic> json) => NormalStats(
        bfr: json["bfr"] == null ? null : Bfr.fromJson(json["bfr"]),
        totalPrice: json["totalPrice"] == null ? null : Bfr.fromJson(json["totalPrice"]),
...
class Jtym {
    ...
    factory Jtym.fromJson(Map<String, dynamic> json) => Jtym(
        ...
        sumOfSquares: json["sumOfSquares"] == null ? null : json["sumOfSquares"],
