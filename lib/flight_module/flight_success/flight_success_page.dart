...
class FlightSuccessPage extends StatefulWidget {
  final type;
  final brfNo;
  final bookingBrfNo;

  FlightSuccessPage(
      {Key? key, required this.brfNo, this.type, this.bookingBrfNo})
      : super(key: key);

  @override
  _FlightSuccessPageState createState() => _FlightSuccessPageState();
}

class _FlightSuccessPageState extends State<FlightSuccessPage> {
